...
public class PETimer {
    ...
    public DateTime GetLocalDateTime() {
        DateTime dt = TimeZoneInfo.ConvertTimeToUtc(startDateTime.AddMilliseconds(nowTime));//TimeZone.CurrentTimeZone.ToLocalTime(startDateTime.AddMilliseconds(nowTime));
        return dt;
    }
