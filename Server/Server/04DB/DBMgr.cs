...
public class DBMgr
{
        ...
        try
        {
            ...
            if (reader.Read())
            {
                ...
                if (_pass.Equals(pass))
                {
                    ...
                    playerData.taskArr = new string[7];
    ...
    private int InsertNewAcctData(string acct, string pass, PlayerData pd)
    {
        ...
        try
        {
            MySqlCommand cmd = new MySqlCommand(
                ...
                "guideid=@guideid,strong=@strong,time=@time,task=@task,fuben=@fuben,friend=@friend", conn);
            cmd.Parameters.AddWithValue("acct", acct);
    ...
    public bool UpdatePlayerData(int id, PlayerData playerData)
    {
        try
        {
            ...
            "guideid=@guideid,strong=@strong,time=@time,task=@task,fuben=@fuben,friend=@friend where id =@id", conn);
